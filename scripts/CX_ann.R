CX_ann <- function(annotation_vec, var1, var2, meth_var1, meth_var2, context) {
  ...
  #source(paste0(scripts_dir,"ann_merge_GRanges.R"))
  dir.create("CX_annotation", showWarnings = F)
  setwd("CX_annotation")
  ...
  write.csv(ann_CX_df, paste0(context,"_CX_annotation.csv"), row.names = F)
